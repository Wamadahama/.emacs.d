...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-doc-face ((,class (:foreground ,LIGHT_BG))))
   `(font-lock-doc-string-face ((,class (:foreground ,yellow-3))))
   `(font-lock-function-name-face ((,class (:foreground ,blue-1))))
   `(font-lock-keyword-face ((,class (:weight bold :foreground ,white-1))))
   ...
   `(font-lock-variable-name-face ((,class (:foreground ,white-3))))
